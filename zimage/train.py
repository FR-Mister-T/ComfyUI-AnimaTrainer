# Bundled from DiffSynth-Studio examples/z_image/model_training/train.py
...
def z_image_parser():
    parser = argparse.ArgumentParser(description="Z-Image LoRA training.")
    parser = add_general_config(parser)
    parser = add_image_size_config(parser)
    parser.add_argument("--tokenizer_path", type=str, default=None, help="Path to tokenizer.")
    parser.add_argument(
        "--enable_npu_patch", default=False, action="store_true",
        help="Enable Ascend NPU fused operator patch (not needed on CUDA/ROCm).",
    )
    return parser
