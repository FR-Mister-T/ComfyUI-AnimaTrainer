...
class NetworkTrainer:
    ...
    def load_unet_lazily(self, args, weight_dtype, accelerator, text_encoders):
        raise NotImplementedError("load_unet_lazily must be implemented when load_target_model returns unet=None")
    ...
    def init_train(self, args):
        ...
        if unet is None:
            # lazy load unet after text encoder caching; text encoders may be freed or replaced
